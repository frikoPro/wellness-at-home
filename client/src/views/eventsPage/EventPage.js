        ...
        <>
            ...
            <Row className="justify-content-center">
                <img src={`http://localhost:8080/` + props.img}
                     className="d-flex justify-content-center" className={`${styles.bannerImg}`}
                     alt={"img"}/>
                    <Row>
                        <Col>
                            <Row>
                            ...
                            <Tabs defaultActiveKey="1">
                                <TabPane tab={<span><AppleOutlined/>Main</span>} key="1">
                                ...
                                <TabPane tab={<span><AndroidOutlined/>Kart og transport</span>} key="2">
                                    <Gmaps {...props}/>
                                </TabPane>
                            </Tabs>
                        </Col>
